    ...
    <div class="content">
        ...
        <Modal v-model="modalStatus" :title="modalTitle" width="600" @on-cancel="handleReset" :mask-closable="false">
            <Form ref="formItem" :model="formItem" :label-width="120" :rules="ruleValidate">
                ...
                <FormItem label="充值奖励" prop="chargeReward">
                    <Input v-model="formItem.chargeReward" style="width:200px" placeholder="请输入充值奖励" number></Input>
                </FormItem>
                <FormItem label="是否按比例赠送" prop="percentage">
                    <Checkbox v-model="formItem.percentage" :true-value="2" :false-value="1">按比例赠送</Checkbox>
                </FormItem>
                <FormItem label="最小充值金额" prop="minChargeValue">
        ...
        methods: {
            ...
            setFormItem (row) {
                if (row) {
                    ...
                    this.formItem.percentage = parseInt(row.percentage);
