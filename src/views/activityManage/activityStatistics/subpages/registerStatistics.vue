...
<template>
    <div class="content">
        <Row class="et-row">
            ...
            <Button type="info" class="add_account" icon="plus-round" :loading="loading" @click="exportListHandle" v-if="g_perm('select')">导出名单</Button>
            </Col>
        </Row>
    ...
    export default {
        ...
        data () {
            return {
                ...
                tableColumns: [
                    ...
                    //     key: 'rewardType',
                    //     render: (h, params) => {
                    //         return h('span', params.row.rewardType == 1 ? '可用' : (params.row.rewardType == 2 ? '冻结' : '半可用半冻结'));
                    //     }
                    // }
                ],
                tableData: [],
        ...
        methods: {
            ...
            getListData () {
                ...
                api.getRegisterStatistics(params).then((res) => {
                    if (res.data.code == 1) {
            ...
            exportListHandle () {
                ...
                this.loading = true;
                api.exportRegisterList(params).then((res) => {
                    this.loading = false;
                    // 处理文件流
